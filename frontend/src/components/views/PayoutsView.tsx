...
// SADB+EDB: Auszahlungen — alle Ambassador-Payouts, Status, Fehler
...
// wechselten). Konsolidiert auf das etablierte View-Komponenten-Muster (DashboardLayout +
// employeeMode-Prop), damit Superadmin in seinem eigenen Dashboard bleibt.
...
export function PayoutsView({ role }: { role: 'superadmin' | 'employee' }) {
  ...
  return (
    <DashboardLayout employeeMode={role === 'employee'} title="Auszahlungen" headerActions={
