...
// ── Wiederverwendbarer Donut fuer die 8 Pflicht-Kuchendiagramme (ARCH-006.1) ──
...
export default function DashboardPage() {
  ...
  return (
    ...
    >
      ...
      {/* ── Analytics vollstaendig integriert: 8 Pflicht-Kuchendiagramme (ARCH-006.1) ── */}
      <div style={{ marginTop: 20, marginBottom: 4 }}>
        <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--text-primary)' }}>📊 Analytics</div>
        <div style={{ fontSize: 11, color: 'var(--text-secondary)' }}>Vollständige App-Aktivität · live aus Supabase, keine Shadow States</div>
      </div>
