...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // ── Typ: commissions — Provisionen pro Ambassador (Balanced Growth v1) ──
        ...
        data: {
          ...
          referrals: referred.map((u: any) => {
            ...
            return {
              ...
              // Balanced Growth v1: 365-Tage-Provisionsfenster ab Registrierung
    ...
    // Balanced Growth v1: Gesamtprovision pro Ambassador (aus Unternehmensanteil, 10% vom Brutto)
    ...
    let data = profiles.map((p: any) => {
      ...
      return {
        ...
        revenueEur:    revenue,
        // Balanced Growth v1: Gesamtprovision aus stripe_ambassador_commissions
