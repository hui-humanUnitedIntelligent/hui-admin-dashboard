...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const { data: poolRows } = await sb
      ...
      .select('total_inflow, project_share, company_share, hui_company_eur, impact_pool_eur, innovation_fund_eur, impact_projects_eur, impact_flex_pool_eur, finance_model, company_phase')
