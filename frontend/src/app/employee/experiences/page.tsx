...
// READ-ONLY Employee-Ansicht: Erlebnisse & Projekte — REALTIME
'use client';
              ...
              {filtered.map(e => (
                <tr key={e.id} style={{ borderBottom:'1px solid var(--border)' }}
                  ...
                  <td style={{ padding:'10px 12px' }}>
                    <Badge variant={e._source==='experiences' ? 'neutral' : 'success'}>{e._source==='experiences' ? 'Erlebnis' : 'Projekt'}</Badge>
                  </td>
