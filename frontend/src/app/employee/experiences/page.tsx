      ...
      <div style={{ padding: '0 0 40px' }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', padding: '64px 24px' }}>
            ...
            <div style={{ marginTop: 20, display: 'inline-flex', gap: 8, flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.5 }}>
            ...
            Struktur, Filter und Tabellenlayout sind implementiert — die Datenanbindung folgt.
          </div>
        </div>
