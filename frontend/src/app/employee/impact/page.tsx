...
// READ-ONLY Employee-Ansicht: Impact Projekte — REALTIME via useImpactProjects()
'use client';
  ...
  return (
    <EmployeeLayout title="Impact Projekte">
      ...
      <div style={{ display:'flex', gap:8, marginBottom:14, flexWrap:'wrap', alignItems:'center' }}>
        ...
        <input type="text" placeholder="Name oder Kategorie…" value={search}
      ...
      <div style={{ fontSize:11, color:'var(--text-muted)', marginBottom:10 }}>
        🟢 Realtime aktiv · {filtered.length} Projekte
      </div>
